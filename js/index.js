...
const validateInputValue = () => {
  ...
  if (calculatorInput[0].value === "") {
    ...
    dateSpan[0].classList.add('calcInput-errorDate')
    errorInputDay = true
    ...
    dateSpan[0].classList.remove('calcInput-errorDate')
    errorInputDay = false
  }
  ...
  if (calculatorInput[1].value === "") {
    ...
    dateSpan[1].classList.add('calcInput-errorDate')
    ...
    dateSpan[1].classList.remove('calcInput-errorDate')
  ...
  if (calculatorInput[2].value === "") {
    ...
    dateSpan[2].classList.add('calcInput-errorDate')
    errorInputYear = true
    ...
    dateSpan[2].classList.remove('calcInput-errorDate')
